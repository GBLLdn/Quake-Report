...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray earthquakeArray = sampleResponse.getJSONArray("features");

            // For each earthquake in the array, create an object.

            for (int i = 0; i < earthquakeArray.length(); i++) {

                // get position i in earthquakeArray for object earthquake information
